...
const state = {
  ...
  auth: {
    ...
    clientID: '82e24763d9a340c2d35b',   // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client ID
    clientSecret: '6d7e969682a2a70a5fae40d1bc96e84b15100999'  // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client Secret
  },
  gitHubUser: null,  // 这个不要修改，这个不要修改，这个不要修改。
  gitHubUsername: '94loveZYY',  // 修改成你自己的 GitHub 账号
  copyright: '2018 - 2088',  // 修改成你自己的
  recordNumber: '浙ICP备5201314号',  // 修改成你自己的备案编号，如果没有备案的话就设置为 null
  repo: '94loveZYY/94loveZYY.github.io',  // 记录 Issue 的仓库的全名「用户名/仓库名」
  ...
  thirdPartySite: [  // 配置你想在左上角展示的第三方站点信息
    {
      ...
      url: 'https://github.com/94loveZYY'  // 第三方站点的 url
    },
    {
      img: 'static/img/weibo.png',
      url: 'http://weibo.com/94loveZYY'
    },
    {
